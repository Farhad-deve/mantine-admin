      ...
      <Stack gap={"lg"}>
        <Stack gap={"4px"}>
          ...
          <Text c={"dimmed"} size="sm">
            Theme object bilan tajriba qiling — o'zgarish barcha sahifalarga
            tarqaladi
          </Text>
        </Stack>
              ...
              <Card withBorder>
                <Stack gap={"sm"}>
                  <Box>
                    ...
                    <Text c={"dimmed"} size="sm">
                      <Code>useMantineColorScheme()</Code> hook'i orqali
                      boshqariladi
                    </Text>
                  </Box>
              ...
              <Card withBorder>
                <Stack gap={"sm"}>
                  <Box>
                    ...
                    <Text c={"dimmed"} size="sm">
                      Theme'dagi <Code>primaryColor</Code> maydoni
                    </Text>
                  </Box>
                  ...
                  <Text c={"dimmed"} size="xs">
                    "brand" — mantine-theme.ts da o'zimiz qo'shgan rang
                  </Text>
                </Stack>
              </Card>
              ...
              <Card withBorder>
                <Stack gap={"sm"}>
                  <Box>
                    ...
                    <Text c={"dimmed"} size="sm">
                      Theme'dagi <Code>defaultRadius</Code> maydoni{" "}
                    </Text>
                  </Box>
                  ...
                  <SegmentedControl
                    value={defaultRadius}
                    onChange={(value) =>
                      setDefaultRadius(value as MantineRadius)
                    }
                    data={[
                      { label: "XS", value: "xs" },
                      { label: "SM", value: "sm" },
            ...
            <Card withBorder>
              <Stack>
                ...
                <Alert
                  title="Eslatma"
                  icon={
                    <FiAlertCircle style={{ transform: "rotate(180deg)" }} />
                  }
                >
                ...
                <Box>
                  <Stack gap={"3px"}>
                    ...
                    <Code block>{currentThemeCode}</Code>
                  </Stack>
                </Box>
              </Stack>
            </Card>
